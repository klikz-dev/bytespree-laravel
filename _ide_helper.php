 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\RequestMacroServiceProvider::boot()
         * @param array $validation_rules
         * @static 
         */ 
        public static function validateWithErrors($validation_rules = [])
        {
                        return \Illuminate\Http\Request::validateWithErrors($validation_rules);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $message, $status_code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function error($message = null, $data = [], $status_code = 500)
        {
                        return \Illuminate\Routing\ResponseFactory::error($message, $data, $status_code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function empty($status_code = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::empty($status_code);
        }
