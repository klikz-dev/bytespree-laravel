...
<br />
<br />
<p>The Salesforce Reconcile ran for a total of {{ count($data) }} tables in the {{  $this->environment->getTeamName() }} team.</p>
<p>Summary:</p>
<table style="border-collapse: collapse;">
        <thead>
            <tr>
                <th style="width: 20%; border: 1px solid black;">Table</th>
                <th style="width: 20%; border: 1px solid black;">Total Salesforce Count</th>
...
@foreach ($data as $tabledata)
    ...
    <table style="border-collapse: collapse;">
        <thead>
            <tr>
                <th colspan="4"style="border: 1px solid black;">Table: {{ $tabledata["table_name"] }}</th>
            </tr>
            <tr>
                <th style="width: 25%; border: 1px solid black;">Date</th>
                <th style="width: 25%; border: 1px solid black;">Salesforce Count</th>
